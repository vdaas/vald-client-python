...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REMOVE'].methods_by_name['Remove']._options = None
  _globals['_REMOVE'].methods_by_name['Remove']._serialized_options = b'\202\323\344\223\002\014\"\007/remove:\001*'
  _globals['_REMOVE'].methods_by_name['RemoveByTimestamp']._options = None
  ...
  _globals['_REMOVE'].methods_by_name['MultiRemove']._options = None
