...
_VALD = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    containing_service=None,
    input_type=payload__pb2._OBJECT_ID,
    output_type=payload__pb2._BACKUP_METAVECTOR,
