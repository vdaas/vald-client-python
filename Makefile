...
IGNORE_PROTOS = meta.proto mirror.proto sidecar.proto
IGNORE_FIND_OPTIONS = $(foreach proto,$(IGNORE_PROTOS),-not -name $(proto))
PROTOS = $(shell find $(PROTO_ROOT)/v1 -name '*.proto' $(IGNORE_FIND_OPTIONS))
